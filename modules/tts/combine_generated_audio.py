...
def combine():
    subtitle_address="./source/tts/original.txt"
    audio_folder_path="./output/tts/persub"


    # Loading filename of the audio and sorting
    arr = list(filter(lambda x: x.find(".png") == -1, os.listdir("./output/tts/persub")))
    ...
    with open(subtitle_address) as f:
        ...
        sf.write("./output/tts/result.wav",endtime,sr,format='WAV',endian='LITTLE',subtype='PCM_16')
